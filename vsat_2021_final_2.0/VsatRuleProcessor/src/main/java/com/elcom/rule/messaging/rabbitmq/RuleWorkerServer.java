...
//import com.elcom.ais.controller.UserController;
 ...
 * @author admin
 */
public class RuleWorkerServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(RuleWorkerServer.class);

//    @Autowired
//    private UserController userController;

    public RuleWorkerServer() {
    }
