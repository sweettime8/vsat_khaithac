...
public interface UserRepository extends PagingAndSortingRepository<User, String>, JpaSpecificationExecutor<User>  {
    ...
    //@Query("UPDATE \"USER\" u SET u.\"PASSWORD\" = :password, u.\"LAST_UPDATE\" = now() WHERE u.\"UUID\" = :uuid ")
    ...
    @Transactional
    @Modifying(clearAutomatically = true)
    //@Query("UPDATE \"USER\" u SET u.\"STATUS\" = :status, u.\"LAST_UPDATE\" = now() WHERE u.\"UUID\" = :uuid ")
