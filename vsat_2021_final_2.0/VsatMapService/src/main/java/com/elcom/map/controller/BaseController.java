package com.elcom.map.controller;

import com.elcom.gateway.message.RequestMessage;
import com.elcom.gateway.message.ResponseMessage;
import com.elcom.map.messaging.rabbitmq.RabbitMQClient;
import com.elcom.map.messaging.rabbitmq.RabbitMQProperties;
import com.elcom.map.model.dto.AuthorizationResponseDTO;
