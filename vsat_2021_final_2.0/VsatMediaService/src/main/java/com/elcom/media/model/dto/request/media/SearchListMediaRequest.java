...
public class SearchListMediaRequest implements Serializable {
    ...
    public SearchListMediaRequest(String startTime, String endTime, List<Integer> dataSource, List<Integer> mediaType, List<String> fileType
                                , String sourceIps, String destIps, String objId, Integer currentPage, Integer rowsPerPage) {
