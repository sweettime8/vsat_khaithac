<template>
  <div class="app-container">
    <h2 class="no-margin-top">Thống kê dung lượng media theo chiều</h2>
    <div class="filter-container">
        ...
        <div >
            <template>            
              <div class="block">
                  <el-select  v-model="optionDate" filterable  @change="changeOption()" style="margin-left:10px; width :120px;vertical-align: center;">
              ...
              <div class="block">
                <el-select  v-model="query.mediaType" multiple collapse-tags clearable placeholder="Loại media" size="small">
...
const mediaFlRlResource = new Resource("statistic/media");
const mediaTypeResource = new Resource("manager/media-type/get-all");
const mediaChartistResource = new Resource("statistic/mediaChartist");
...
//
  ...
  methods: {
    ...
    async getList() {
      ...
      const { data } = await mediaChartistResource.listByPost(this.query);
