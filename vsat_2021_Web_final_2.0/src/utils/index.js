...
/**
 * Convert date format to save db
 * @param  {String} date [d/M/Y]
 * @return {String}      [Y-M-d]
 */
export function convertDateToSaveDB(date) {
  if (date) {
...
export function createGoogleLoginUrl() {
  return 'https://accounts.google.com/o/oauth2/auth/oauthchooseaccount?ux_mode=redirect&scope=email&redirect_uri=' + process.env.VUE_APP_GG_REDIRECT_URI + '&response_type=code&client_id=' + process.env.VUE_APP_GG_CLIENT_ID + '&approval_prompt=force&flowName=GeneralOAuthFlow';
}
